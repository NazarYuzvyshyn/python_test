...
class ResultsPage:
    ...
    def get_random_place_type(self):
        ...
        type_index = random.randint(0, type_names.__len__())
    ...
    def get_random_place(self):
        ...
        place_index = random.randint(0, places.__len__())
    ...
    def submit(self):
        ...
        if self.counter == 0:
            self.ticket.price = int(clear_price(text))
        else:
            self.ticket.round_price = int(clear_price(text))
        self.counter = 1
        current_url = get_url()
        info("-----------------------------------")
